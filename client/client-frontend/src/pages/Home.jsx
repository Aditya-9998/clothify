...
const Home = () => {
  return (
    ...
    >
      <div className="bg-white bg-opacity-60 backdrop-blur-sm p-6 sm:p-10 rounded-2xl shadow-2xl text-center max-w-lg sm:max-w-2xl w-full">
        <h1 className="text-3xl sm:text-5xl font-bold mb-4 text-red-900">
          Welcome to Clothify
        </h1>
        <p className="text-base sm:text-xl text-red-800 font-medium leading-relaxed">
